(function(e) {
          ...
          N = function(e, t, n, r) {
            var o = j(n),
              ...
              s = M(a, function(e) {
                var t = e.localName,
                  n = e.value;
                return -1 !== A.indexOf(t) && -1 !== n.indexOf('url(' + o);
              });
            s.forEach(function(e) {
              return (e.value = e.value.replace(new RegExp(H(o), 'g'), i));
            }),
              O(t, o, i);
          },
          ...
          I = (function(e) {
            ...
            return (
              ...
              (t.prototype.updateUrls = function(e, t) {
                ...
                return N(this.node, n, _(e) + '#', _(t) + '#'), !0;
              }),
    ...
    function r(e, t) {
      for (var n = [], r = {}, o = 0; o < t.length; o++) {
        var i = t[o],
          ...
          c = i[2],
          l = i[3],
          d = { id: e + ':' + o, css: s, media: c, sourceMap: l };
  ...
  '5a74': function(e, t, n) {
            ...
            n('fieldset', [
              ...
              n('div', { staticClass: 'search-bar__fields' }, [
                ...
                n('input', {
                  ...
                  class: {
                    'search-bar__input': !0,
                    'with-dropdown': e.dropdownItems.length,
                  },
                  attrs: {
                    type: 'text',
                    id: 'search-query',
    ...
    var q = C(I, $, N, !1, Q, null, null, !0),
      ...
      D = {
        ...
        methods: {
          ...
          handleKeyUp(e) {
            const t = (e) => {
              console.log('received suggestions: ', e),
    ...
    var Z = C(R, V, A, !1, P, null, null, !0),
      ...
      Y = {
        ...
        methods: {
          ...
          factorSearchKeyup({ event: e, updateSuggestions: t }) {
            this.$emit('factor:search:keyup', {
              updateSuggestions: t,
              event: e,
            });
          },
          factorSearchSuggestionsClicked(e) {
            this.$emit('factor:search-suggestions:clicked', { item: e });
          },
          factorSearchClear() {
            this.$emit('factor:search:clear');
          },
    ...
    var fe = C(ue, ce, le, !1, he, null, null, !0),
      pe = fe.exports,
      we = function() {
        var e = this,
          t = e.$createElement,
    ...
    var xe = C(ve, we, ge, !1, be, null, null, !0),
      ye = xe.exports;
    window.customElements.define('moz-components-factor-footer', _(s.a, j)),
      window.customElements.define('moz-components-factor-header', _(s.a, ee)),
      window.customElements.define('moz-components-factor-icon', _(s.a, se)),
      window.customElements.define('moz-components-factor-panel', _(s.a, pe)),
      ...
      function e() {
        ...
        try {
          ...
          var n,
            ...
            i = /.*at [^(]*\((.*):(.+):(.+)\)$/gi,
            a = /@([^@]*):(\d+):(\d+)\s*$/gi,
            s = i.exec(f.stack) || a.exec(f.stack),
            c = (s && s[1]) || !1,
            l = (s && s[2]) || !1,
          ...
          for (var h = 0; h < u.length; h++) {
            ...
            if (u[h].src === c) return u[h];
            if (c === d && u[h].innerHTML && u[h].innerHTML.trim() === o)
              return u[h];
          }
          return null;
        }
