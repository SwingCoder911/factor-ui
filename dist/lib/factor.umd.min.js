(function(e, t) {
  ...
  return (function(e) {
      ...
      (function(t) {
        (function(t, n) {
          ...
          var u,
            ...
            v = function(e) {
              (this.config = n(h, e || {})), (this.symbols = []);
            };
          ...
          var m = function(e) {
              var t = !!document.importNode,
                n = new DOMParser().parseFromString(e, 'image/svg+xml')
                  .documentElement;
            ...
            C = function(e) {
              var t = [];
              return (
                w(e.querySelectorAll('style')).forEach(function(e) {
            ...
            _ = 'linearGradient, radialGradient, pattern, mask, clipPath',
            z = function(e, t) {
              return (
                void 0 === t && (t = _),
            ...
            I = function(e, t, n, r) {
              var o = H(n),
                ...
                c = M(a, function(e) {
                  var t = e.localName,
                    n = e.value;
                  return -1 !== V.indexOf(t) && -1 !== n.indexOf('url(' + o);
                });
              c.forEach(function(e) {
                return (e.value = e.value.replace(new RegExp(j(o), 'g'), i));
              }),
                A(t, o, i);
            },
            N = { MOUNT: 'mount', SYMBOL_MOUNT: 'symbol_mount' },
            F = (function(e) {
              function t(t) {
                var o = this;
                void 0 === t && (t = {}), e.call(this, n(y, t));
                var i = r();
                ...
                (this._handleLocationChange = u),
                  ...
                  c.locationChangeAngularEmitter && k(c.locationChangeEvent),
                  i.on(N.MOUNT, function(e) {
                    c.moveGradientsOutsideSymbol && z(e);
                  }),
                  i.on(N.SYMBOL_MOUNT, function(e) {
                    c.moveGradientsOutsideSymbol && z(e.parentNode),
                      (b.isIE() || b.isEdge()) && C(e);
                  });
              }
              e && (t.__proto__ = e),
              ...
              return (
                ...
                (t.prototype.attach = function(e) {
                  ...
                  return (
                    (n.node = r),
                    this.symbols.forEach(function(e) {
                      e.mount(n.node), t._emitter.emit(N.SYMBOL_MOUNT, e.node);
                    }),
                ...
                (t.prototype.updateUrls = function(e, t) {
                  ...
                  return I(this.node, n, B(e) + '#', B(t) + '#'), !0;
                }),
    ...
    '23e7': function(e, t, n) {
      ...
      e.exports = function(e, t) {
        var n,
          ...
          m = e.global,
          g = e.stat;
        if (((l = m ? r : g ? r[p] || c(p, {}) : (r[p] || {}).prototype), l))
          for (d in t) {
            if (
              ((h = t[d]),
              e.noTargetGet ? ((v = o(l, d)), (f = v && v.value)) : (f = l[d]),
              (n = u(m ? d : p + (g ? '.' : '#') + d, e.forced)),
              !n && void 0 !== f)
            ) {
              if (typeof h === typeof f) continue;
              s(h, f);
            }
            (e.sham || (f && f.sham)) && i(h, 'sham', !0), a(l, d, h, e);
          }
      };
    },
    '241c': function(e, t, n) {
    ...
    5319: function(e, t, n) {
      ...
      r('replace', 2, function(e, t, n, r) {
        ...
        return [
          ...
          function(e, r) {
            if ((!g && y) || ('string' === typeof r && -1 === r.indexOf(w))) {
              var i = n(t, e, this, r);
            ...
            while (1) {
              ...
              if ((C.push(B), !p)) break;
              var k = String(B[0]);
              '' === k && (s.lastIndex = u(h, a(s.lastIndex), x));
            }
            for (var _ = '', z = 0, M = 0; M < C.length; M++) {
              B = C[M];
              for (
                var S = String(B[0]),
                  E = d(f(c(B.index), h.length), 0),
                  O = [],
                  H = 1;
                H < B.length;
                H++
              ...
              } else L = b(S, h, E, O, j, r);
              E >= z && ((_ += h.slice(z, E) + L), (z = E + S.length));
            }
            return _ + h.slice(z);
          },
        ];
    ...
    '69f3': function(e, t, n) {
      ...
      e.exports = { set: r, get: o, has: i, enforce: v, getterFor: p };
    },
    '6af3': function(e, t, n) {
      'use strict';
      n.r(t);
      ...
      (c[p] = !0),
        (e.exports =
          ...
          function(e, t) {
            ...
            return (
              null !== e
                ? ((m[h] = o(e)), (n = new m()), (m[h] = null), (n[p] = e))
                : (n = b()),
              void 0 === t ? n : i(n, t)
            );
          });
        ...
        function e() {
          ...
          try {
            ...
            for (var l = 0; l < u.length; l++) {
              ...
              if (a === s && u[l].innerHTML && u[l].innerHTML.trim() === n)
                return u[l];
            }
            return null;
          }
    ...
    a9e3: function(e, t, n) {
      ...
      if (i(g, !y(' 0o1') || !y('0b1') || y('+0x1'))) {
        for (
          ...
          c(y, (C = k[_])) && !c(B, C) && p(B, C, v(y, C));
        (B.prototype = w), (w.constructor = B), a(o, g, B);
      }
    },
    ac1f: function(e, t, n) {
      'use strict';
    ...
    b622: function(e, t, n) {
      ...
      e.exports = function(e) {
        return (
          i(u, e) || (c && i(l, e) ? (u[e] = l[e]) : (u[e] = d('Symbol.' + e))),
          u[e]
        );
      };
    },
    ...
    fae3: function(e, t, n) {
      ...
      if (
        (n.r(t),
        n.d(t, 'FactorBlockTemplate', function() {
          return R;
        }),
        n.d(t, 'FactorFlowTemplate', function() {
          return W;
        }),
        n.d(t, 'FactorFooter', function() {
          return N;
        }),
        n.d(t, 'FactorHeader', function() {
          return H;
        }),
        n.d(t, 'FactorIcon', function() {
          return b;
        }),
        n.d(t, 'FactorPanel', function() {
          return re;
        }),
        n.d(t, 'FactorSearchBar', function() {
          return z;
        }),
        'undefined' !== typeof window)
      ) {
      ...
      var a = function() {
          ...
          return n(
            ...
            [
              n(
                'FactorHeader',
                { attrs: { searchBarConfig: e.searchBarConfig } },
                [
                  e.hasLogo
                    ? n('template', { slot: 'logo' }, [e._t('logo')], 2)
                    : e._e(),
                  n('template', { slot: 'nav' }, [e._t('nav')], 2),
                  n('template', { slot: 'profile' }, [e._t('profile')], 2),
                ],
                2,
              ),
              n('main', { staticClass: 'f-main' }, [e._t('main')], 2),
              n(
                'FactorFooter',
                [n('template', { slot: 'links' }, [e._t('footer-links')], 2)],
                2,
              ),
            ],
            1,
        ...
        s = function() {
          var e = this,
            t = e.$createElement,
            n = e._self._c || t;
          return n('header', { staticClass: 'f-header' }, [
            n(
              'div',
            ...
            n('div', { staticClass: 'f-header__column' }, [
              n('nav', { staticClass: 'f-nav' }, [e._t('nav')], 2),
              n('div', { staticClass: 'f-profile' }, [e._t('profile')], 2),
            ]),
          ]);
        },
        u = [],
        l = function() {
          ...
          return n(
            ...
            [
              n('fieldset', [
                n('legend', { staticClass: 'visually-hidden' }, [
                  e._v('search'),
                ]),
                n('div', { staticClass: 'search-bar__fields' }, [
                  n(
                    'label',
                    {
              ...
              e.dropdownItems.length
                ? n(
                    ...
                    e._l(e.dropdownItems, function(t, r) {
                      return n(
                        'li',
                        {
                          key: r,
        ...
        v =
          ...
          n('5319'),
          {
            ...
            computed: {
              iconHref() {
                return '#' + n('63d5')(`./${this.id}.svg`).default.id;
              },
            },
            methods: {
              handleIconClicked(e) {
      ...
      var k = m(C, l, d, !1, B, null, null, !0),
        _ = k.exports,
        z = _,
        M = {
          name: 'FactorHeader',
          components: { FactorSearchBar: z },
          props: {
            hideSearchBar: { type: Boolean, default: !1 },
            searchBarConfig: { type: Object, default: null },
            noLogo: { type: Boolean, default: !1 },
          },
          methods: {
            searchBarHandler: function(e) {
              this.searchBarConfig.handler &&
                (this.$emit('factor-search', this.searchQuery),
          ...
          computed: {
            ...
            searchBarLabel: function() {
              return this.searchBarConfig.label
                ? this.searchBarConfig.label
                : '';
            },
            searchBarValue: function() {
              return this.searchBarConfig.value
                ? this.searchBarConfig.value
                : '';
            },
            searchBarSuggestions: function() {
        ...
        S = M,
        E = (n('98b6'), m(S, s, u, !1, null, null, null)),
        O = E.exports,
        H = O,
        j = function() {
          var e = this,
            t = e.$createElement,
            n = e._self._c || t;
          return n('footer', { staticClass: 'f-footer' }, [e._t('links')], 2);
        },
        A = [],
        L = { name: 'Footer' },
        V = L,
        T = (n('1f6e'), m(V, j, A, !1, null, null, null)),
        I = T.exports,
        N = I,
        F = {
          name: 'FactorBlockTemplate',
          components: { FactorHeader: H, FactorFooter: N },
          props: { searchBarConfig: { type: Object, default: null } },
          computed: {
            hasLogo: function() {
              return !!this.$slots['logo'];
            },
        ...
        $ = F,
        P = (n('249f'), m($, a, c, !1, null, null, null)),
        U = P.exports,
        R = U,
        q = function() {
          var e = this,
        ...
        G = Q,
        K = (n('1196'), m(G, q, D, !1, null, null, null)),
        Y = K.exports,
        W = Y,
        X = function() {
          var e = this,
            ...
            [
              ...
              !e.hideContent && e.hasTitle
                ? n(
                    ...
                    [n('h2', [e._v(e._s(e.title))]), e._t('header')],
                    2,
                  )
                : e._e(),
              e.hideContent
        ...
        ee = Z,
        te = (n('ec0b'), m(ee, X, J, !1, null, null, null)),
        ne = te.exports,
        re = ne;
    },
    fb06: function(e, t, n) {
